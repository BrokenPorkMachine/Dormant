...
/// Perplexity API connector for LLM interactions
class PerplexityConnector: LLMProviderProtocol {
    let providerType: LLMProvider = .perplexity
            ...
            Task {
                do {
                    ...
                    guard httpResponse.statusCode == 200 else {
                        ...
                        print("Perplexity API error (\(httpResponse.statusCode)): \(errorMessage)")
    ...
    func validateConfiguration(_ agent: LLMAgent) -> Bool {
        let supportedModels = ["llama-3-sonar-small-32k-chat", "llama-3-sonar-large-32k-chat", "llama-3-70b-instruct"]
    ...
    func getContextWindowSize(for model: String) -> Int {
        ...
        case let model where model.contains("32k"):
            return 32768
        case let model where model.contains("70b"):
            return 4096
        default:
            return 4096
        }
